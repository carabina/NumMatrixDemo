#
#  Be sure to run `pod spec lint NumMatrixDemo.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "ckm"
  # s.authors            = { "ckm" => "kaiminchen@126.com" }
  # s.social_media_url   = "http://twitter.com/ckm"
  ...
  s.source_files  = "Classes", "NumMatrixDemo/**/*.{h,m}"
